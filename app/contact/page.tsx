...
const infoData = [
  { title: "Phone", description: "+8801300315569", icon: <Phone /> },
  { title: "Email", description: " imonmia818@gmail.com", icon: <Mail /> },
  {
    title: "Address",
        ...
        <div className="w-full md:w-1/3 flex flex-col justify-center gap-4 md:gap-8">
          {infoData?.map((item) => (
            <div key={item?.title} className="flex items-center space-x-4">
              <span className="bg-lightSky/20 p-4 rounded-md">{item?.icon}</span>
              <div>
